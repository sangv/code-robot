...
public interface WordTagger {
    ...
    List<String> estimate(String testFileLocation, String outputFileLocation, Map<Sentence.WordTag,Integer> taggedWords, Map<Sentence.WordTag, Float> expectationMap, Map<Sentence.WordTag,Integer> originalTaggedWords, Map<Sentence.WordTag,Float> originalExpectationMaps) throws IOException;
